...
class PublicRecipeAPITests(TestCase):
    """Test unauthenticated API Recipe requests."""
...
class PrivateRecipeAPITests(TestCase):
    """Test Authenticated API Recipe requests"""
    ...
    def test_retrive_reecipes(self):
    ...
    def test_get_recipe_detail(self):
        ...
        recipe = creat_recipe(user=self.user)
    ...
    def test_recipe_other_users_recipe_error(self):
        ...
        new_user = create_user(email='user2@example.com', password='test123')
        recipe = creat_recipe(user=new_user)
...
class ImageUploadTests(TestCase):
    ...
    def setUp(self):
        ...
        self.client.force_authenticate(self.user)
        self.recipe = creat_recipe(user=self.user)
